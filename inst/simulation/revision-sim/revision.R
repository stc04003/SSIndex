...
set.seed(1); dat <- simDat(400, "M2", TRUE, FALSE)

seed <- sample(1:1e7, 1)
set.seed(seed)
dat <- simDat(400, "M2", TRUE, FALSE)
head(dat, 20)
...
t0 <- seq(0, quantile(fit$info$yi, .9), length.out = 50)
## range(fit$info$xb)
b0 <- seq(min(fit$info$xb), max(fit$info$xb), length = 100)
...
lines(b0, apply(f3, 2, function(x) sum(diff(c(0, t0)) * x)), 's', col = 2)
...
load("M-approach/M2n200c.RData")
load("M-approach/M3n200c.RData")
load("M-approach/M4n200c.RData")
load("M-approach/M5n200c.RData")
load("M-approach/M2n400c.RData")
load("M-approach/M3n400c.RData")
load("M-approach/M4n400c.RData")
load("M-approach/M5n400c.RData")
load("M-approach/M2n200.RData")
load("M-approach/M3n200.RData")
load("M-approach/M4n200.RData")
load("M-approach/M5n200.RData")
load("M-approach/M2n400.RData")
load("M-approach/M3n400.RData")
load("M-approach/M4n400.RData")
load("M-approach/M5n400.RData")
