...
xtable(rbind(sumPwr(200, "M2", FALSE),
             sumPwr(400, "M2", FALSE)), digits = 3)

xtable(rbind(sumPwr(200, "M5", FALSE),
             sumPwr(400, "M5", FALSE)), digits = 3)


xtable(rbind(sumPwr(200, "M2", TRUE),
             sumPwr(400, "M2", TRUE)), digits = 3)

xtable(rbind(sumPwr(200, "M5", TRUE),
             sumPwr(400, "M5", TRUE)), digits = 3)
